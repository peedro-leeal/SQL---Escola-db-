...
(ID_Professor, Nome_Professor, Data_Nascimento, Genero, Telefone_Contato_Professor, Email_Professor)
VALUES 
...
-- Inserções na tabela Turma_Disciplinas
...
-- Inserções na tabela Turma_Alunos
